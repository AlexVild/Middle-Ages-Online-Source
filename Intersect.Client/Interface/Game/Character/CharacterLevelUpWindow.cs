...
namespace Intersect.Client.Interface.Game.Character
{
    public class CharacterLevelUpWindow
    {
        ...
        public CharacterLevelUpWindow(CharacterWindow parent, Canvas gameCanvas)
        {
            ...
            StatRows[LevelUpAssignments.Evasion] = new LevelUpRow(StatRowContainer, "EVASION", Globals.Me.Stat[(int)Stats.Evasion], Options.Instance.PlayerOpts.BaseStatSkillIncrease, new Color(86, 179, 192), new Color(181, 223, 228), $"Dodge chance vs. opponent's accuracy. Increases status resist by 1% every {Options.Instance.CombatOpts.EvasionStatusResistEveryMod} pts.", this, LevelUpAssignments.Evasion);
            StatRows[LevelUpAssignments.Accuracy] = new LevelUpRow(StatRowContainer, "ACCURACY", Globals.Me.Stat[(int)Stats.Accuracy], Options.Instance.PlayerOpts.BaseStatSkillIncrease, new Color(99, 196, 70), new Color(188, 230, 174), $"Hit chance vs. opponent's evasion. Increases crit chance by 1% every {Options.Instance.CombatOpts.AccuracyCritEveryDivisor} pts.", this, LevelUpAssignments.Accuracy);
            StatRows[LevelUpAssignments.Speed] = new LevelUpRow(StatRowContainer, "SPEED", Globals.Me.Stat[(int)Stats.Speed], Options.Instance.PlayerOpts.BaseStatSkillIncrease, new Color(200, 145, 62), new Color(232, 208, 170), "Determines movement speed. Decreases health & mana regen times.", this, LevelUpAssignments.Speed);
