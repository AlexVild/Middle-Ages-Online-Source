...
namespace Intersect.Client.Interface.Shared
{
    public class SettingsWindow
    {
        ...
        private readonly LabeledCheckBox mFaceTargetOnLockCheckbox;

        private readonly LabeledCheckBox mLeftClickTargetCheckbox;

        private readonly LabeledCheckBox mScanlinesCheckbox;

        private readonly LabeledCheckBox mCombatScreenFlashCheckbox;
        ...
        public SettingsWindow(Canvas parent, MainMenu mainMenu, EscapeMenu escapeMenu)
        {
            ...
            mTapToTurnCheckbox = new LabeledCheckBox(mGameSettingsContainer, "TapToTurnCheckbox")
            {
                Text = Strings.Settings.TapToTurn
            };

            mScanlinesCheckbox = new LabeledCheckBox(mGameSettingsContainer, "ScanlinesCheckbox")
            {
                Text = Strings.Settings.EnableScanlines
            };

            mFaceTargetOnLockCheckbox = new LabeledCheckBox(mGameSettingsContainer, "FaceOnLockCheckbox")
            {
                Text = Strings.Settings.FaceOnLock
            };

            mLeftClickTargetCheckbox = new LabeledCheckBox(mGameSettingsContainer, "LeftClickTargetCheckbox")
            {
                Text = Strings.Settings.LeftClickTarget
            };

            mCombatScreenFlashCheckbox = new LabeledCheckBox(mGameSettingsContainer, "CombatFlashCheckbox")
            {
                Text = Strings.Settings.CombatFlash
            };

            mCombatScreenShakeCheckbox = new LabeledCheckBox(mGameSettingsContainer, "CombatShakeCheckbox")
            {
                Text = Strings.Settings.CombatShake
            };
        ...
        public void Show(bool returnToMenu = false)
        {
            ...
            mScanlinesCheckbox.IsChecked = Globals.Database.EnableScanlines;
            mFaceTargetOnLockCheckbox.IsChecked = Globals.Database.FaceOnLock;
