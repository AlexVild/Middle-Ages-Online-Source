...
namespace Intersect.Server.Entities.Events
{
    ...
    public static partial class CommandProcessing
    {
        ...
        )
        {
            ...
            {
                var variable = InstanceVariableBase.Get(command.VariableId);
                if (variable != null)
                {
                    type = (int)variable.Type;
                }
    ...
    public static partial class CommandProcessing
    {
                    ...
                    else
                    {
                        switch (command.VariableType)
                        {
                            ...
                            case VariableTypes.InstanceVariable:
                                if (MapController.TryGetInstanceFromMap(player.MapId, player.MapInstanceId, out var mapInstance))
                                {
                                    amount = mapInstance.GetInstanceVariable(command.VariableDescriptorId)?.Value.Integer;
                                }
       ...
       )
        {
            ...
            player.OpenEquipmentPicker(WeaponPickerResult.Enhancement, command.CurrencyItemId, command.CostMultiplier);
       ...
       )
        {
            ...
            player.OpenEquipmentPicker(WeaponPickerResult.Upgrade, command.CurrencyItemId, command.CostMultiplier);
